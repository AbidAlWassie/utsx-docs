    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">utsx docs</span>
        </a>
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <div className="relative">
            ...
            >
              ...
              <Image className="w-8 h-8 rounded-full" width={32} height={32} src={images.icon} alt="user photo" />
            </button>
            ...
            {isDropdownOpen && (
              ...
              >
                <div className="px-4 py-3">
                  ...
                  <span className="block text-sm text-gray-500 truncate dark:text-gray-400">name@test.com</span>
                </div>
